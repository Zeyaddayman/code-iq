...
const Question = ({ question, userAnswers, handleChange, focusableElementsRef }: IProps) => {
    return (
        <section className="select-none">
            ...
            <ul className="flex flex-col gap-3 mb-10">
                {question.answers.map((answer, i) => (
                    ...
                    >
                        <input
                            ref={(el) => (focusableElementsRef.current[i] = el)}
                            type="radio"
                        ...
                        <label
                            htmlFor={answer}
                            className="p-4 rounded-md block shadow-sm bg-white peer-checked:bg-primary peer-checked:text-white ring-2 ring-transparent hover:ring-primary peer-focus:ring-primary transition cursor-pointer"
                        >
                            {answer}
                        </label>
                    </div>
